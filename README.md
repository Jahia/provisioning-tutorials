...
| [02-luxe-mariadb](./02-luxe-mariadb)                | With a MariaDB database, install `Luxe`                                                     |
| [03-augmented-search](./03-augmented-search)        | Add an Elasticsearch single-node cluster, install and configure `Augmented-Search` for Luxe |
